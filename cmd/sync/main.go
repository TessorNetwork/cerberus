...
import (
	...
	"github.com/TessorNetwork/cerberus/internal/consumer/blockchain"
...
var opts = struct {
	...
	BlockchainNode                   string        `long:"blockchain.node" env:"BLOCKCHAIN_NODE" default:"zeus.testnet.furya.xyz:9090" description:"furya node grpc address"`
